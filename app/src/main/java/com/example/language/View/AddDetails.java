...
import com.example.language.Misc_Section.ImageUtils;
...
public class AddDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        section=findViewById(R.id.german);
        ...
        SecAdapter=new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,this.getResources().getStringArray(R.array.german));
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(name.getText().toString().equals("")&&dataSnapshot.exists()){
                            ...
                            section.setSelection(Arrays.asList(AddDetails.this.getResources()
                                    .getStringArray(R.array.german)).indexOf(user.sect));
